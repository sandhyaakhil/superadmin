...
<script src="{{ asset('adm') }}/dist/js/sweetalert.min.js"></script>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Bulk Upload Sheet</h3>
            </div>
            <!-- Light table -->
                     ...
                     <td>
                       <form class="" id="widget_section" name="widget_section">
                               ...
                               <div class="form-group">
                                   <td><input type="button" onclick="download()" class="btn btn-primary btn-sm" value="Download Template"/></td>
                               </div>
    ...
    function download()
    {
        var url = '{{ route("admin.product_import_template.export") }}';
